            ...
            <div className="container-custom">
                ...
                <div className="flex items-center justify-between pt-6 pb-3">
                    ...
                    <div className="absolute left-80 top-32">
                        <Link href="/">
                            <h1 className={`text-6xl font-bold tracking-tight leading-tight whitespace-nowrap ${isHomepage ? 'text-red-400' : 'text-red-600'}`}>
                            ...
                            {navigationItems.map((item) => (
                                <div key={item.name} className="relative">
                                    {item.children ? (
                                        ...
                                        >
                                            <button className={`flex items-center space-x-1 py-1 text-3xl font-medium transition-colors ${
                                                isHomepage
                                        ...
                                        <Link
                                            href={item.href}
                                            className={`block py-1 text-3xl font-medium lowercase transition-colors ${
                                                pathname === item.href
                                                    ? isHomepage
                                                        ? 'text-red-400'
                                                        : 'text-primary-600'
